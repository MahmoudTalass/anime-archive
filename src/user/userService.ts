import mongoose, { HydratedDocument, isValidObjectId, PipelineStage } from "mongoose";
...
class UserService {
   ...
   async updateUserAnimeEntry(
      ...
      if (!animeExistsInUserList) {
         ...
         throw new AppError("Anime with the given malId does not exist in the user's list.", 404);
      }
